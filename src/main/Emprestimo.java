...
public class Emprestimo {
	...
	public LocalDate getDataDevolucaoPrevista() {
        // TODO remover coment√°rio depois de adaptar o m√©todo na classe Usu√°rio
	...
	public String toString() {
	    ...
	    if(dataDevolucaoReal == null) {
            dataDevolucao = "Data devoluÁ„o prevista: " + dataDevolucaoPrevista.format(dateFormat);
        } else {
	        dataDevolucao = "Data de devoluÁ„o: " + dataDevolucaoReal.format(dateFormat);
        }

        String titulo = "TÌtulo: " + exemplar.getLivro().getTitulo();
